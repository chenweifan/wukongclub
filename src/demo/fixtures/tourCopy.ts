...
export const TOUR_COPY: Record<string, TourCopy> = {
  ...
  'fv-sidebar': {
    title: '十一个入口，四个已交付',
    description:
      '资讯、影神图、攻略、我的 —— 这四个模块是本次交付的实现范围；其余入口标着「未交付」，点进去会说明它的原计划。点击徽记可以折叠侧栏。',
  },
  'fv-theme': {
    title: '三套主题随时切换',
    description:
  ...
  'fv-modules': {
    title: '模块入口与交付范围',
    description:
      '已交付的四个模块可以直接走通；未交付模块也列在这里，但带明确标记 —— 首页不承诺站点没有的东西。',
  },
  'fv-wiki': {
    title: '引导会自动跨页',
    description:
      '你刚才被自动带到了影神图页 —— 步骤绑定路由，跨页时引导会跳转并把目标元素挖出来高亮。这里就是卡片墙：筛选、对比与词条图谱都在这一页。',
  },
  'fv-tokens': {
    title: '令牌自检',
